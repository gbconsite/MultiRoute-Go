...
Sie können nun mit gedrückter linker Maustaste die Straßenankerpunkte (rosa, auf der Straße) an die richtige Stelle verschieben. Dies wiederholen Sie für alle Punkte, die das betrifft. Wenn Sie fertig sind, speichern Sie die Änderungen ab.
